...
```{r echo=FALSE}
## Source: https://stackoverflow.com/questions/37116632/r-markdown-html-number-figures
...
<B><h1> Exploratory Analysis of Injury Data </h1></B>

# A brief look

```{r gg_injphoto, fig.width = 9.5, height = 6.8, fig.cap = capFig("Timeline of the football players' follow-up period together with the injuries they sustained")}
...
```{r ranking_fig, echo = FALSE, fig.width = 9.5, fig.height = 7.4, fig.cap = capFig("Barplots of each players' injury incidence (left) and injury burden (right) in descending order")}
...
```{r, fig.width = 9.5, fig.height = 5, fig.cap = capFig("Risk matrix, that displays injury incidence (likelihood) against injury burden (severity), according to injury type")}
...
```{r, fig.width = 9.5, fig.height = 5, fig.cap=capFig("Risk matrix, that displays injury incidence (likelihood) against injury burden (severity), according to the location of the injury")}
...
```{r, fig.cap = capFig("Injured and injury free player proportions in a monthly basis")}
